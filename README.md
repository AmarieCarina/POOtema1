...
Functionalitatile proiectului depind de tipul utilizatorului. Astfel, pentru Client, Manager si Curier, sunt listate optiunile de functionare in cadrul unui meniu interactiv.
  * Client - istoricul comenzilor plasate, in functie de numele clientului
...
Datele de intrare sunt specificate in functia `int main()` a programului, acestea fiind: produsele de pe stoc, cu atributele obligatorii specificate, comenzile lansate in ziua curenta, si o lista de livrari de efectuat, bazata pe comenzile procesate.
